...
export default function Header() {
  ...
  // Passou para o layout de desktop com o menu aberto: o painel some, mas o
  // véu continuaria montado e o estado, aberto.
  useEffect(() => {
    if (!menuOpen) return;
  ...
  return (
    <>
      {/*
        Véu do menu mobile (z-40: entre o conteúdo e o header). Fecha ao toque
        fora e, com touch-action: none, segura a rolagem do fundo enquanto o
        menu está aberto — sem mexer no overflow do body, que quebraria o
        position: sticky do hero.
      */}
      <div
        onClick={() => setMenuOpen(false)}
        aria-hidden="true"
        className={`md:hidden fixed inset-0 z-40 bg-terra-dark/60 backdrop-blur-sm touch-none transition-opacity duration-500 ${
