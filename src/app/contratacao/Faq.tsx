...
export default function Faq() {
  ...
  return (
    <section
      ...
      className="py-24 md:py-32 bg-terra-cream"
    >
        ...
        <div ref={listRef} className="reveal divide-y divide-terra-gold/25">
          {faq.map((item) => (
            <details key={item.question} className="group py-5">
              <summary className="flex cursor-pointer items-center justify-between gap-4 font-serif text-terra-dark text-lg list-none marker:content-none">
                {item.question}
                <svg
              ...
              <p className="mt-3 text-terra-dark/75 leading-relaxed">
                {item.answer}
              </p>
            </details>
          ))}
